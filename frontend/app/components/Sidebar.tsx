...
export default function Sidebar({
  ...
  const navItems = [
    ...
    { id: "risk", label: "Risk Analysis", icon: BarChart3Icon },
    { id: "infrastructure", label: "Infrastructure", icon: LayersIcon },
  ...
  return (
    <aside className="w-64 bg-[#0B132B] border-r border-[#1E3A5F] flex flex-col justify-between shrink-0 h-screen sticky top-0 select-none z-30 transition-colors duration-200">
      <div className="flex flex-col flex-1 overflow-y-auto custom-scrollbar">
        ...
        <div className="p-5 border-b border-[#1E3A5F] flex items-center gap-3 bg-[#0d1b2a]/60">
          <div className="relative">
            {/* Cyan dual-triangle glyph */}
            <div className="w-10 h-10 rounded-xl bg-gradient-to-br from-cyan-500/20 to-blue-600/30 border border-cyan-500/40 flex items-center justify-center text-cyan-400 shadow-lg shadow-cyan-500/10">
              ...
              return (
                ...
                >
                  ...
                  {item.id === "risk" && criticalAlertsCount > 0 && (
                    <span className="px-1.5 py-0.5 text-[10px] font-bold rounded-full bg-rose-500/20 text-rose-400 border border-rose-500/40 animate-pulse">
                      {criticalAlertsCount}
                    </span>
                  )}
                </button>
        ...
        <div className="px-3 pt-6">
          <p className="px-3 pb-2 text-[10px] font-bold uppercase tracking-wider text-slate-400 flex items-center gap-1.5">
          ...
          <div className="space-y-2">
            <button
              ...
              className="w-full flex items-center gap-2.5 px-3 py-2 rounded-lg text-xs font-bold text-slate-200 bg-[#132238]/90 hover:bg-[#1E3A5F] border border-[#1E3A5F] hover:border-cyan-500/50 transition-all cursor-pointer text-left group"
            >
              <BarChart3Icon className="w-4 h-4 text-cyan-400 group-hover:scale-110 transition-transform" />
            ...
            <button
              ...
              className="w-full flex items-center gap-2.5 px-3 py-2 rounded-lg text-xs font-bold text-slate-200 bg-[#132238]/90 hover:bg-[#1E3A5F] border border-[#1E3A5F] hover:border-cyan-500/50 transition-all cursor-pointer text-left group"
            >
              <UsersIcon className="w-4 h-4 text-cyan-400 group-hover:scale-110 transition-transform" />
            ...
            <button
              ...
              className="w-full flex items-center gap-2.5 px-3 py-2 rounded-lg text-xs font-bold text-slate-200 bg-[#132238]/90 hover:bg-[#1E3A5F] border border-[#1E3A5F] hover:border-cyan-500/50 transition-all cursor-pointer text-left group"
            >
              <FileTextIcon className="w-4 h-4 text-cyan-400 group-hover:scale-110 transition-transform" />
        ...
        <div className="m-3 mt-6 p-3 rounded-xl bg-[#132238]/60 border border-[#1E3A5F]">
          <div className="flex items-center justify-between mb-1.5">
            ...
            >
              ...
              />
              {isConnected ? "HARDWARE" : "SIMULATION"}
            </span>
          </div>
          <div className="text-[10px] font-mono text-slate-400 space-y-0.5">
            <div className="flex justify-between">
              <span>Node ID:</span>
              <span className="text-slate-300 font-semibold">ORACLE-ESP32-01</span>
            </div>
            <div className="flex justify-between">
              <span>Sensor Pins:</span>
      ...
      {/* Sidebar Footer with City Skyline Silhouette */}
      <div className="p-3 border-t border-[#1E3A5F] bg-[#0d1b2a]/90 flex flex-col items-center text-center">
        {/* Vector silhouette of city skyline */}
        <div className="w-full h-10 mb-2 overflow-hidden opacity-40">
        ...
        <p className="text-[10px] font-semibold text-cyan-300/80 tracking-wide">
